...
func (_m *Cache) Get(ctx context.Context, key string, dest any) error {
...
func (_c *Cache_Get_Call) Run(run func(ctx context.Context, key string, dest any)) *Cache_Get_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *Cache_Get_Call) RunAndReturn(run func(context.Context, string, any) error) *Cache_Get_Call {
	_c.Call.Return(run)
	return _c
}
