...
func encodeGetTaskHistoryResponse(response GetTaskHistoryRes, w http.ResponseWriter, span trace.Span) error {
	switch response := response.(type) {
	case *GetTaskHistoryOK:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(200)
...
func encodeInviteUserToTeamResponse(response InviteUserToTeamRes, w http.ResponseWriter, span trace.Span) error {
	switch response := response.(type) {
	case *TeamMember:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(200)
